...
package com.sheronova.telegram.handler;
...
public class TrafficLawsQuestHandler extends TelegramLongPollingBot {
    ...
    public TrafficLawsQuestHandler(DefaultBotOptions botOptions, String botUsername, String botToken) {
        super(botOptions);
    ...
    */
/*private InlineKeyboardMarkup getMarathonQuest(String userId) {
